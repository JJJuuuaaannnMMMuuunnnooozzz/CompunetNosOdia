...
export default function Home({ chatId } = {}) {
    ...
    <div class="main">
      ...
      <div class="panels">
        ...
        <section class="panel">
          ...
          <!-- 5. Añadir a Grupo (grupo + miembro único) -->
          ...
          <!-- 6. Enviar Mensaje a Grupo (grupo + emisor + mensaje) -->
  ...
  const handleFormSubmit = async (url, body, okMsg) => {
    ...
    try {
      ...
      if (url.includes("/history")) {
        // Si es la ruta de historial, mostrar en popup
  ...
  modal.addEventListener("click", (e) => {
    if (e.target === modal) modal.classList.add("hidden"); // clic fuera del contenido
  });
